...
namespace BabyMemory_V2.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = BabyMemory_V2Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(BabyMemory_V2DbContext context)
        {
            _context = context;
        }
