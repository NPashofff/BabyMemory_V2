...
{
    public abstract class BabyMemory_V2WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BabyMemory_V2WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BabyMemory_V2WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BabyMemory_V2DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BabyMemory_V2DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BabyMemory_V2DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BabyMemory_V2DbContext, Task<T>> func)
        {
            T result;
